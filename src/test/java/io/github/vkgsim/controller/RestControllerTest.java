...
public class RestControllerTest {
    ...
    public void testCreateUserFolder() throws Exception {
        ...
        when(ontopController.createUserFolder(username)).thenReturn("User folder created.");
    ...
    public void testSendQuery() throws Exception {
        ...
        when(ontopController.ontopQuery(query, owlFileType)).thenReturn("Query result");
